...
+ (NSString *)deviceId {
    NSString *UDID = [SAMKeychain passwordForService:[BitchApplication applicationBundleId] account:@"UDID"];
    if (UDID && UDID.length > 0) {
        ...
        BOOL isSaved = [SAMKeychain setPassword:newUDID forService:[BitchApplication applicationBundleId] account:@"UDID"];
        if (!isSaved) {
