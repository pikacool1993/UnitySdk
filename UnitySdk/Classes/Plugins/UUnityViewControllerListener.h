...
@protocol UUnityViewControllerListener<NSObject>
@optional
...
void UnityRegisterViewControllerListener(id<UUnityViewControllerListener> obj);
void UnityUnregisterViewControllerListener(id<UUnityViewControllerListener> obj);
