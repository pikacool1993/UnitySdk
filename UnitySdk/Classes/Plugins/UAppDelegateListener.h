...
@protocol UAppDelegateListener<ULifeCycleListener>
@optional
...
void UnityRegisterAppDelegateListener(id<UAppDelegateListener> obj);
void UnityUnregisterAppDelegateListener(id<UAppDelegateListener> obj);
